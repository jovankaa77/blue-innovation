            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4"> 
                        ...
                        <div style="flex";>
                            <a class="btn btn-primary btn-sm" href="ongoing.php">Kembali</a>
                        </div> 
                        <br>
                        <div class="card mb-4" >
                            ...
                            <div class="card-body">
                                <form method="POST" action="../queryTBD/query.php">
                                    <input type="hidden" name="action" value="editTanggalKerja">
                                    <?php
                                    ...
                                    <br>
                                    <div class="form-group row">
                                        <label for="inputOptions" class="col-sm-2 col-form-label">Atur Dari Tanggal Kerja</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="Input Tanggal Kerja" value="<?= $data['dari_tanggal'] ?>" name="dari_tanggal" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        <label for="inputOptions" class="col-sm-2 col-form-label">Atur Sampai Tanggal Kerja</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="Input Tanggal Kerja" value="<?= $data['sampai_tanggal'] ?>" name="sampai_tanggal" required>
                                        </div>
                                    </div>
                                    <br>
